...
class RoomTest {
	...
	@Test
	void testSetNameRoomEspasosVazio() {
		CustomException exception = Assertions.assertThrows(CustomException.class, () -> room.setNameRoom("     "));	
		assertEquals("Erro: informado um nome vazio ou com mais de 50 caracteres!",exception.getMessage());
	}
	
	@Test
	void testSetNameRoomAcima() {
	...
	@Test
	void testSetCapacityRoomNegativo() throws CustomException {
	...
	@Test
	void testSetCapacityRoomIgualZero() throws CustomException {
